...
chrome.runtime.onMessage.addListener(async(message, sender, sendResponse) => {
    ...
    // console.log(message.recordType === "current_tab");
...
function injectHtml(){
    ...
    wrapper.innerHTML = `
    <div class="control-wrapper" style="position:fixed;bottom:3rem; left: 40%;">
    <p class="record-time">
...
function savingToEndpoint(videoBlob){
    ...
    fetch('http://localhost/videoProcessor/endpoint.php', {
        method: 'POST',
        body: formData
      })
